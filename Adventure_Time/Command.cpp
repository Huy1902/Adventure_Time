...
void DefeatEnemyCommand::execute()
{
	...
	MapManager::getInstance()->getCurrentMap()->getPlayer()->getMaxStatus()->ATK += 1;
	MapManager::getInstance()->getCurrentMap()->getPlayer()->getMaxStatus()->STA += 20;
}
...
void FirstBossCommand::execute()
{
	...
	MapManager::getInstance()->getCurrentMap()->getPlayer()->getMaxStatus()->ATK += 10;
}
