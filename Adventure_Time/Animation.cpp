...
void Animation::draw()
{
	TextureManager::getInstance()->drawSpritePicByCol(mTextureID, mPosition.getX(), mPosition.getY(), mW, mH, GameManager::getInstance()->getRenderer(), mIndexFrame / mSpeed, mFlip);
}
